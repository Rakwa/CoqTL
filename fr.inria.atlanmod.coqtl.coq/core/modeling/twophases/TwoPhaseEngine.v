 ...
 (t: TransformationEngine ts) :=
  {
    ...
    applyLinkOnPatternTraces: OutputPatternNext -> Transformation -> SourceModel -> list SourceModelElement -> nat -> TargetModelElement -> list TraceLink -> option TargetModelElement;
