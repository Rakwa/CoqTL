...
# operation: add to base specification certification
...
class RegressionTest(unittest.TestCase):
    ...
    def test_bsc_add_UPoBS(self):
        # clean up
        self.reset()

        # prepare paths
        change_nature = "./bsc/add/"
        id = "UPoBS.coqproj"
