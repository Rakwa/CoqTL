...
# operation: modify to child specification
...
class RegressionTest(unittest.TestCase):
    ...
    def test_cs_modify_UPoBS(self):
        # clean up
        self.reset()

        # prepare paths
        change_nature = "./cs/modify/"
        id = "UPoBS.coqproj"
