...
# operation: add to child specification certification
...
class RegressionTest(unittest.TestCase):
    ...
    def test_csc_add_UPoBS(self):
        # clean up
        self.reset()

        # prepare paths
        change_nature = "./csc/add/"
        id = "UPoBS.coqproj"
