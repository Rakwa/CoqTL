...
# operation: modify to base specification certification
...
class RegressionTest(unittest.TestCase):
    ...
    def test_bsc_modify_UPoBS(self):
        # clean up
        self.reset()

        # prepare paths
        change_nature = "./bsc/modify/"
        id = "UPoBS.coqproj"
        change_in = "core/Certification.v"
        base = "./"
    ...
    def test_bsc_modify_UPoCS(self):
        # clean up
        self.reset()
    ...
    def test_bsc_modify_BSC(self):
        ...
        # execute, expect not preserved
        msg = self.cmd(_Coqproject)
        self.assertTrue(msg != 0)

    def test_bsc_modify_CSC(self):
        # clean up
        self.reset()
