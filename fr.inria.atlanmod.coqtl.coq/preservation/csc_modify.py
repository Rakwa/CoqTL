...
# operation: modify to child specification certification
...
class RegressionTest(unittest.TestCase):
    ...
    def test_csc_modify_UPoBS(self):
        # clean up
        self.reset()

        # prepare paths
        change_nature = "./csc/modify/"
        id = "UPoBS.coqproj"
        change_in = "core/modeling/ModelingCertification.v"
        base = "./"
    ...
    def test_csc_modify_UPoCS(self):
        # clean up
        self.reset()
